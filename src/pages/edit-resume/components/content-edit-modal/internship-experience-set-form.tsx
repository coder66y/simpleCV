...
export interface IInternshipExperienceBaseSetFormProps {
  ...
  onChange?: (
    values: IInternshipExperienceSetFormValues,
    index: number,
  ) => void;
  index: number;
  length?: number;
...
/** 基础表单 */
function InternshipExperienceBaseSetForm(
  props: IInternshipExperienceBaseSetFormProps,
) {
        ...
        <Space>
          ...
          {length > 1 && index < length - 1 && (
            <Button
              type="primary"
              ghost
              onClick={() => handleSort(SortTypeEnum.DOWN)}
            >
              下移
              <i className="iconfont">&#xe8f6;</i>
            </Button>
          ...
          {length > 1 && (
            <Button
              type="primary"
              ghost
              onClick={() => handleSort(SortTypeEnum.DELETE)}
            >
              删除
              <i className="iconfont">&#xe600;</i>
            </Button>
  ...
  return (
    <div className="common-list-set-form-wrapper">
      ...
      <Button type="primary" ghost className="add-btn" onClick={onAdd}>
        ...
        {
          infoModuleList?.find(
            (item) => item.key === ContentConfigKeyEnum.INTERNSHIP_EXPERIENCE,
          )?.title
        }
      </Button>
    </div>
