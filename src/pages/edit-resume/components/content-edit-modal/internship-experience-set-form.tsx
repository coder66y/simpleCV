import { EDIT_RESUME_NAME_SPACE, IEditResumeModel, IInternshipExperienceValues } from "@/models/edit-resume";
...
/** 表单初始值 */
export interface IInternshipExperienceSetFormValues extends Omit<IInternshipExperienceValues, 'start' | 'end'> {
  start?: Dayjs;
  end?: Dayjs;
};
