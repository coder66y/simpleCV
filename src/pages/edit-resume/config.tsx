...
export const MODULE_CONFIG = {
  ...
  icons: new Map<string, ReactNode>([
    ...
    [
      ContentConfigKeyEnum.WORK_EXPERIENCE,
      <i className="iconfont">&#xe63c;</i>,
    ],
    [
      ContentConfigKeyEnum.SCHOOL_EXPERIENCE,
      <i className="iconfont">&#xe689;</i>,
    ],
    [
      ContentConfigKeyEnum.PROJECT_EXPERIENCE,
      <i className="iconfont">&#xe615;</i>,
    ],
    [ContentConfigKeyEnum.SKILLS, <i className="iconfont">&#xe60f;</i>],
    [
      ContentConfigKeyEnum.SELF_EVALUATION,
      <i className="iconfont">&#xe61b;</i>,
    ],
    ...
    [
      ContentConfigKeyEnum.INTERNSHIP_EXPERIENCE,
      <i className="iconfont">&#xe648;</i>,
    ],
  ]),
};
